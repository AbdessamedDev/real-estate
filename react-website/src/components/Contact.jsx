...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "a29ddbce-85d2-45df-8ae4-8c96e9d814d4");
  ...
  return (
    ...
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='contact'>
      ...
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>
        Ready To Make A Move? Lets Build Your Futur Together.
        </p>
        <form onSubmit={onSubmit} className="max-w-2xl mx-auto text-gray-600 pt-8">
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/2 text-left">
                Your Name 
                <input type="text" className="w-full border border-gray-300 rounded py-3 px-4 mt-2" placeholder="Your Name" required/>
            </div>
            <div className="w-full md:w-1/2 text-left md:pl-4">
                Your Email
                <input type="email" className="w-full border border-gray-300 rounded py-3 px-4 mt-2" placeholder="Your Email" required/>
            </div>
          </div>
